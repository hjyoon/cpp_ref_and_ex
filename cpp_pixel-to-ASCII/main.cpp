...
int main() {
	...
	fpBmp = fopen("Test_192.bmp", "rb");    // 비트맵 파일을 바이너리 모드로 열기
	if (fpBmp == NULL) {    // 파일 열기에 실패하면 프로그램 종료
		printf("비트맵 파일 오픈 실패!!");
		return 0;
	}
